...
$getPlaces = "SELECT * FROM travel1.place WHERE locationName = 'Ho Chi Minh City'";
...
<body id="top">
  ...
  <header class="header" data-header>
    ...
    <section class="hero" id="home">
      <div class="container">
        <h2 class="h1 hero-title">Available in HoChiMinh City</h2>

        <p class="hero-text">
        Ho Chi Minh City, formerly known as Saigon, is a bustling metropolis in southern Vietnam that pulsates with energy and vitality.
        </p>
    </section>
    ...
    <article>
      ...
      <div class="video">
        <video autoplay muted loop id="myVideo">
          <source src="..\assets\video\14385-256955049_small.mp4" type="video/mp4">
        </video>
      </div>
      ...
      <section class="package" id="package">
        <div class="container">
          ...
          <h2 class="h2 section-title">Hotels In Ho Chi Minh City</h2>
